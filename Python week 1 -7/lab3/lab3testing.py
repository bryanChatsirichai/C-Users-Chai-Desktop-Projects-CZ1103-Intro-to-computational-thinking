...
def display(word):
    ...
    while count < 3:
        if text_colour == background_colour:
            count += 1
            print('Display and background is the same please re-enter ')
        ...
        print('Exit as fail 3 times') # only i fai; 3 times
    print(word, text_speed, text_colour, background_colour)  # treat as sense_hat printing
    sense.show_message(word, text_speed,text_colour,background_colour)


display(word = input("enter display msg "))